                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu animated fadeInUp">
                                    ...
                                    <li><a href="WEB-INF/pages/login.html">Logout</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
        ...
        <div class="col-md-2">
            <div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="WEB-INF/pages/calendar.html"><i class="glyphicon glyphicon-calendar"></i> Calendar</a></li>
                    <li><a href="WEB-INF/pages/stats.html"><i class="glyphicon glyphicon-stats"></i> Statistics (Charts)</a></li>
                    <li><a href="back/listtables"><i class="glyphicon glyphicon-list"></i> Tables</a></li>
                    <li><a href="WEB-INF/pages/buttons.html"><i class="glyphicon glyphicon-record"></i> Buttons</a></li>
                    <li><a href="WEB-INF/pages/editors.html"><i class="glyphicon glyphicon-pencil"></i> Editors</a></li>
                    <li><a href="/listtables"><i class="glyphicon glyphicon-tasks"></i> Forms</a></li>
                    <li class="submenu">
                        <a href="#">
                        ...
                        <ul>
                            ...
                            <li><a href="WEB-INF/pages/signup.html">Signup</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
